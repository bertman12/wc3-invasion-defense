...
u = BlzCreateUnitWithSkin(p, FourCC("hgtw"), 4992.0, 3328.0, 270.000, FourCC("hgtw"))
...
u = BlzCreateUnitWithSkin(p, FourCC("hgtw"), 5632.0, 3904.0, 270.000, FourCC("hgtw"))
...
u = BlzCreateUnitWithSkin(p, FourCC("h004"), 0.0, -2048.0, 270.000, FourCC("h004"))
u = BlzCreateUnitWithSkin(p, FourCC("hbar"), 128.0, -1152.0, 270.000, FourCC("hbar"))
u = BlzCreateUnitWithSkin(p, FourCC("hbar"), -512.0, -1792.0, 270.000, FourCC("hbar"))
...
u = BlzCreateUnitWithSkin(p, FourCC("hbar"), -8960.0, 8320.0, 270.000, FourCC("hbar"))
u = BlzCreateUnitWithSkin(p, FourCC("h003"), -1792.0, 6144.0, 270.000, FourCC("h003"))
u = BlzCreateUnitWithSkin(p, FourCC("h003"), 5632.0, 3264.0, 270.000, FourCC("h003"))
u = BlzCreateUnitWithSkin(p, FourCC("htow"), -9024.0, 8768.0, 270.000, FourCC("htow"))
...
u = BlzCreateUnitWithSkin(p, FourCC("hcas"), -1408.0, 17088.0, 270.000, FourCC("hcas"))
...
u = BlzCreateUnitWithSkin(p, FourCC("hlum"), -5984.0, 864.0, 270.000, FourCC("hlum"))
u = BlzCreateUnitWithSkin(p, FourCC("hlum"), -6304.0, 4064.0, 270.000, FourCC("hlum"))
...
u = BlzCreateUnitWithSkin(p, FourCC("hlum"), 4704.0, 2144.0, 270.000, FourCC("hlum"))
u = BlzCreateUnitWithSkin(p, FourCC("hlum"), 4832.0, 160.0, 270.000, FourCC("hlum"))
...
u = BlzCreateUnitWithSkin(p, FourCC("nwgt"), 1639.7, -1746.2, 270.000, FourCC("nwgt"))
...
u = BlzCreateUnitWithSkin(p, FourCC("hfoo"), 5134.5, 3371.8, 356.385, FourCC("hfoo"))
u = BlzCreateUnitWithSkin(p, FourCC("hfoo"), 5583.8, 3760.4, 144.409, FourCC("hfoo"))
...
u = BlzCreateUnitWithSkin(p, FourCC("N005"), 17544.1, -27031.6, -87.171, FourCC("N005"))
SetUnitState(u, UNIT_STATE_MANA, 0)
...
u = BlzCreateUnitWithSkin(p, FourCC("n006"), 2973.7, 19669.9, -78.932, FourCC("n006"))
u = BlzCreateUnitWithSkin(p, FourCC("n006"), 2865.3, 19598.6, -58.955, FourCC("n006"))
...
u = BlzCreateUnitWithSkin(p, FourCC("u000"), 17929.7, -27380.3, -85.015, FourCC("u000"))
SetUnitState(u, UNIT_STATE_MANA, 0)
u = BlzCreateUnitWithSkin(p, FourCC("u001"), 18549.5, -27127.0, -88.254, FourCC("u001"))
SetUnitState(u, UNIT_STATE_MANA, 0)
u = BlzCreateUnitWithSkin(p, FourCC("u002"), 19113.7, -27119.6, 265.559, FourCC("u002"))
u = BlzCreateUnitWithSkin(p, FourCC("nzom"), 17334.2, -27362.1, -55.421, FourCC("nzom"))
u = BlzCreateUnitWithSkin(p, FourCC("n007"), 19557.9, -27161.7, -75.909, FourCC("n007"))
u = BlzCreateUnitWithSkin(p, FourCC("nsoc"), 18819.9, -27119.5, -82.091, FourCC("nsoc"))
SetUnitState(u, UNIT_STATE_MANA, 0)
u = BlzCreateUnitWithSkin(p, FourCC("ugar"), 18534.4, -26963.2, 266.435, FourCC("ugar"))
u = BlzCreateUnitWithSkin(p, FourCC("nskm"), 17615.4, -27387.5, -49.748, FourCC("nskm"))
SetUnitState(u, UNIT_STATE_MANA, 0)
u = BlzCreateUnitWithSkin(p, FourCC("uabo"), 17892.6, -27034.4, 259.833, FourCC("uabo"))
u = BlzCreateUnitWithSkin(p, FourCC("umtw"), 17514.0, -26683.1, -83.809, FourCC("umtw"))
u = BlzCreateUnitWithSkin(p, FourCC("uobs"), 17282.4, -27049.2, -77.362, FourCC("uobs"))
SetUnitState(u, UNIT_STATE_MANA, 0)
end
...
gg_rct_waygateBase = Rect(1408.0, -1952.0, 1920.0, -1472.0)
gg_rct_waygateNorth = Rect(-1664.0, 16480.0, -1152.0, 16800.0)
gg_rct_zNorthWestspawn2 = Rect(-5440.0, 15392.0, -3392.0, 16512.0)
gg_rct_undead_unit_showcase = Rect(16864.0, -27648.0, 20032.0, -26272.0)
end
