...
u = BlzCreateUnitWithSkin(p, FourCC("h005"), 512.0, -1472.0, 270.000, FourCC("h005"))
u = BlzCreateUnitWithSkin(p, FourCC("h005"), 1408.0, -1472.0, 270.000, FourCC("h005"))
u = BlzCreateUnitWithSkin(p, FourCC("h005"), 640.0, -1472.0, 270.000, FourCC("h005"))
u = BlzCreateUnitWithSkin(p, FourCC("h005"), 768.0, -1472.0, 270.000, FourCC("h005"))
u = BlzCreateUnitWithSkin(p, FourCC("h005"), 896.0, -1472.0, 270.000, FourCC("h005"))
u = BlzCreateUnitWithSkin(p, FourCC("h005"), 1024.0, -1472.0, 270.000, FourCC("h005"))
u = BlzCreateUnitWithSkin(p, FourCC("h005"), 1152.0, -1472.0, 270.000, FourCC("h005"))
...
SetStartLocPrio(10, 5, 6, MAP_LOC_PRIO_LOW)
...
SetEnemyStartLocPrio(10, 1, 3, MAP_LOC_PRIO_HIGH)
SetEnemyStartLocPrio(10, 2, 4, MAP_LOC_PRIO_HIGH)
SetEnemyStartLocPrio(10, 3, 6, MAP_LOC_PRIO_HIGH)
SetEnemyStartLocPrio(10, 4, 7, MAP_LOC_PRIO_HIGH)
end
...
DefineStartLocation(10, -9152.0, 27008.0)
