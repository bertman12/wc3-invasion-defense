...
u = BlzCreateUnitWithSkin(p, FourCC("h00I"), -958.8, 4297.3, 288.477, FourCC("h00I"))
u = BlzCreateUnitWithSkin(p, FourCC("h00I"), -859.1, 4279.0, 177.632, FourCC("h00I"))
end
...
u = BlzCreateUnitWithSkin(p, FourCC("h002"), -1408.0, 5632.0, 270.000, FourCC("h002"))
...
u = BlzCreateUnitWithSkin(p, FourCC("hkni"), -8473.2, 7438.3, -46.098, FourCC("hkni"))
...
u = BlzCreateUnitWithSkin(p, FourCC("u009"), -618.8, 5692.5, 251.350, FourCC("u009"))
life = GetUnitState(u, UNIT_STATE_LIFE)
SetUnitState(u, UNIT_STATE_LIFE, 0.30 * life)
end
